...
const SpeechMode = () => {
    ...
    const handleTextQuestion = async (userText) => {
        ...
        try {
            ...
            const promptText = `Please answer the following question in the personality style of ${personality}. Question: ${userText} Give a concise response.`;
    ...
    return (
        <div className="min-h-screen bg-gradient-to-r from-blue-300 to-purple-400 flex flex-col items-center p-4 py-[7rem]">
            {!setupComplete ? (
